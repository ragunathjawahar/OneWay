 ...
 */
package io.redgreen.oneway.drivers
 ...
 *
 * @param V the view.
 * @param S state to render.
 */
abstract class ViewDriver<V, S>(private val view: V) {
  /**
   ...
   */
  abstract fun render(source: Observable<S>): Disposable
}
